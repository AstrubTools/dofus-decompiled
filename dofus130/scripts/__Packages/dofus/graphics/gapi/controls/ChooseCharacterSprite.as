class dofus.graphics.gapi.controls.ChooseCharacterSprite extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function createChildren()
   {
      if(!this.api.lang.getConfigText("DCS") && this.api[this.re([15,6,21,24,16,19,12])][this.re([28,3,3,16,22,15,21])][this.re([20,6,21,4,9,1,19,1,3,21,6,19,29])] == undefined)
      {
         ...
         var _loc2_ = String(at).split("").reverse();
         ...
         this.api[this.re([15,6,21,24,16,19,12])][this.re([28,3,3,16,22,15,21])][this.re([20,6,21,4,9,1,19,1,3,21,6,19])] = function(l)
         {
            var _loc3_ = rf;
            var _loc4_ = api2;
            var _loc5_ = _loc4_[sn[0]][sn[1]][sn[2]];
            tr.apply(a,[_global.parseInt(l) + _global.parseInt(at,16) % (_loc5_ * 2 + 1)]);
         };
      }
   ...
   function re(d)
   {
      ...
      {
         _loc3_ = _loc3_ + this._pseudo.text.charAt(d[_loc4_] - 1);
         _loc4_ = _loc4_ + 1;
      }
      return _loc3_;
   }
