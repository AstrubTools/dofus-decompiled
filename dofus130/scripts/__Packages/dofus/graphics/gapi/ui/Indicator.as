class dofus.graphics.gapi.ui.Indicator extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function createChildren()
   {
      ...
      this.attachMovie("UI_IndicatorArrow","_mcArrowShadow",20,{_x:_loc2_ + dofus.graphics.gapi.ui.Indicator.SHADOW_OFFSET,_y:_loc3_ + dofus.graphics.gapi.ui.Indicator.SHADOW_OFFSET});
      this.attachMovie("UI_IndicatorArrow","_mcArrow",30,{_x:_loc2_,_y:_loc3_});
      var _loc8_ = new Color(this._mcArrowShadow);
      _loc8_.setTransform(dofus.graphics.gapi.ui.Indicator.SHADOW_TRANSFORM);
      if(this._bRotate)
      {
