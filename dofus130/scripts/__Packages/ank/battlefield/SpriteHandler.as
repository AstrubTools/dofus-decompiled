class ank.battlefield.SpriteHandler
{
   ...
   function launchVisualEffect(sID, oEffectData, nCellNum, nDisplayType, mSpriteAnimation, sTargetID, oSpriteToHideDuringAnimation, bForceVisible)
   {
      var _loc10_ = this._oSprites.getItemAt(sID);
      if(_loc10_ == undefined)
      {
         ank.utils.Logger.err("[launchVisualEffect] Sprite " + sID + " inexistant");
         return undefined;
      }
      var _loc11_ = this._oSprites.getItemAt(sTargetID);
      var _loc12_ = _loc10_.mc;
      var _loc13_ = _loc10_.sequencer;
      var _loc14_ = true;
      switch(nDisplayType)
      {
         case 0:
      ...
      _loc12_._ACTION = _loc10_;
      _loc12_._OBJECT = _loc12_;
      _loc13_.addAction(false,this,this.autoCalculateSpriteDirection,[sID,nCellNum]);
      if(mSpriteAnimation != undefined)
      {
         var _loc16_ = typeof mSpriteAnimation;
         if(_loc16_ == "object")
         {
            ...
            var _loc17_ = _loc10_.cellNum;
            var _loc18_ = this._mcBattlefield.mapHandler.getCellData(_loc17_);
            var _loc19_ = this._mcBattlefield.mapHandler.getCellData(nCellNum);
            var _loc20_ = ank.battlefield.utils.Pathfinding.getDirectionFromCoordinates(_loc18_.x,_loc18_.y,_loc19_.x,_loc19_.y,false);
            var _loc21_ = ank.battlefield.utils.Compressor.makeFullPath(this._mcBattlefield.mapHandler,ank.battlefield.utils.Pathfinding.pathFind(this._mcBattlefield.mapHandler,_loc17_,nCellNum,{bIgnoreSprites:true,bWithBeginCellNum:true}));
            _loc21_.pop();
            var _loc22_ = _loc21_[_loc21_.length - 1];
            this.moveSprite(sID,_loc21_,_loc13_,false,mSpriteAnimation[0],false,true);
            _loc13_.addAction(false,_loc12_,_loc12_.setDirection,[ank.battlefield.utils.Pathfinding.convertHeightToFourDirection(_loc20_)]);
            _loc13_.addAction(true,_loc12_,_loc12_.setAnim,[mSpriteAnimation[1]]);
            if(_loc14_)
            {
               _loc13_.addAction(_loc15_,this._mcBattlefield.visualEffectHandler,this._mcBattlefield.visualEffectHandler.addEffect,[_loc10_,oEffectData,nCellNum,nDisplayType,_loc11_,!bForceVisible?_loc10_.isVisible:true]);
            }
            var _loc23_ = ank.battlefield.utils.Compressor.makeFullPath(this._mcBattlefield.mapHandler,ank.battlefield.utils.Pathfinding.pathFind(this._mcBattlefield.mapHandler,_loc22_,_loc17_,{bIgnoreSprites:true,bWithBeginCellNum:true}));
            this.moveSprite(sID,_loc23_,_loc13_,false,mSpriteAnimation[2],false,true);
            _loc13_.addAction(false,_loc12_,_loc12_.setDirection,[_loc20_]);
            if(mSpriteAnimation[3] != undefined)
            {
               _loc13_.addAction(false,_loc12_,_loc12_.setAnim,[mSpriteAnimation[3]]);
            }
            _loc13_.execute();
            return undefined;
         }
         if(_loc16_ == "string")
         {
            _loc13_.addAction(true,_loc12_,_loc12_.setAnim,[mSpriteAnimation,false,true]);
         }
      }
      if(oSpriteToHideDuringAnimation != undefined)
      {
         _loc13_.addAction(false,this,this.hideSprite,[oSpriteToHideDuringAnimation.id,true]);
      }
      if(_loc14_)
      {
         _loc13_.addAction(_loc15_,this._mcBattlefield.visualEffectHandler,this._mcBattlefield.visualEffectHandler.addEffect,[_loc10_,oEffectData,nCellNum,nDisplayType,_loc11_,!bForceVisible?_loc10_.isVisible:true]);
      ...
      if(oSpriteToHideDuringAnimation != undefined)
      {
         _loc13_.addAction(false,this,this.hideSprite,[oSpriteToHideDuringAnimation.id,false]);
      }
      _loc13_.execute();
   }
