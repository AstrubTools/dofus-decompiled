class ank.utils.SharedObjectFix extends Object
{
   ...
   function SharedObjectFix(params)
   {
      super();
      this._so = !params.persistence?SharedObject.getLocal(params.name,params.localPath,params.secure):SharedObject.getRemote(params.name,params.remotePath,params.persistence,params.secure);
