class dofus.graphics.gapi.ui.BigStoreSell extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   {
      var _loc5_ = this.gapi.loadUIComponent("AskYesNo","AskYesNoSell",{title:this.api.lang.getText("BIGSTORE"),text:this.api.lang.getText("DO_U_SELL_ITEM_BIGSTORE",["x" + this._oData["quantity" + nQuantityIndex] + " " + oItem.name,nPrice]),params:{id:oItem.ID,quantityIndex:nQuantityIndex,price:nPrice}});
   ...
   function click(oEvent)
   {
      switch(oEvent.target._name)
      {
         case "_btnRemove":
            ...
            break;
         case "_btnAdd":
            var _loc3_ = _global.parseInt(this._tiPrice.text,10);
